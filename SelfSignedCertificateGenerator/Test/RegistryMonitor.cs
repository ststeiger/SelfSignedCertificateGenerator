...
namespace RegistryUtils
{
		...
		: System.IDisposable
	{
		...
		private static extern int RegOpenKeyEx(System.IntPtr hKey, string subKey, uint options, int samDesired,
		                                       out System.IntPtr phkResult);

		[System.Runtime.InteropServices.DllImport("advapi32.dll", SetLastError = true)]
		private static extern int RegNotifyChangeKeyValue(System.IntPtr hKey, bool bWatchSubtree,
		                                                  RegChangeNotifyFilter dwNotifyFilter, System.IntPtr hEvent,
		                                                  bool fAsynchronous);
		...
		private static readonly System.IntPtr HKEY_CLASSES_ROOT = new System.IntPtr(unchecked((int) 0x80000000));
		private static readonly System.IntPtr HKEY_CURRENT_USER = new System.IntPtr(unchecked((int) 0x80000001));
		private static readonly System.IntPtr HKEY_LOCAL_MACHINE = new System.IntPtr(unchecked((int) 0x80000002));
		private static readonly System.IntPtr HKEY_USERS = new System.IntPtr(unchecked((int) 0x80000003));
		private static readonly System.IntPtr HKEY_PERFORMANCE_DATA = new System.IntPtr(unchecked((int) 0x80000004));
		private static readonly System.IntPtr HKEY_CURRENT_CONFIG = new System.IntPtr(unchecked((int) 0x80000005));
		private static readonly System.IntPtr HKEY_DYN_DATA = new System.IntPtr(unchecked((int) 0x80000006));
		...
		{
			System.EventHandler handler = RegChanged;
			if (handler != null)
				handler(this, null);
		}
		...
		private System.IntPtr _registryHive;
		private string _registrySubName;
		private object _threadLock = new object();
		private System.Threading.Thread _thread;
		private bool _disposed = false;
		private System.Threading.ManualResetEvent _eventTerminate = 
		...
		public RegChangeNotifyFilter RegChangeNotifyFilter
		{
			...
			set
			{
				...
				{
					if (IsMonitoring)
						throw new System.InvalidOperationException("Monitoring thread is already running");
		...
		private void InitRegistryKey(string name)
		{
			...
			switch (nameParts[0])
			{
				...
				default:
					_registryHive = System.IntPtr.Zero;
					throw new System.ArgumentException("The registry hive '" + nameParts[0] + "' is not supported", "value");
			}
			...
			lock (_threadLock)
			{
				if (!IsMonitoring)
				{
					...
					_thread = new System.Threading.Thread(
						new System.Threading.ThreadStart(MonitorThread)
					);
		...
		public void Stop()
		{
			...
			lock (_threadLock)
			{
				System.Threading.Thread thread = _thread;
				if (thread != null)
				{
					_eventTerminate.Set();
					thread.Join();
		...
		private void ThreadLoop()
		{
			...
			try
			{
				System.Threading.AutoResetEvent _eventNotify = new System.Threading.AutoResetEvent(false);
				System.Threading.WaitHandle[] waitHandles = new System.Threading.WaitHandle[] 
				{_eventNotify, _eventTerminate};

				while (!_eventTerminate.WaitOne(0, true))
				{
					result = RegNotifyChangeKeyValue(registryKey, true, _regFilter
						, _eventNotify.Handle, true);
			...
			{
				if (registryKey != System.IntPtr.Zero)
				{
